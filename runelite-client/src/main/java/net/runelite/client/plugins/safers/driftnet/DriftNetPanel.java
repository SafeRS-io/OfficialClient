...
public class DriftNetPanel extends OverlayPanel {
	...
	@Inject
	public DriftNetPanel(Client client) {
		super(null);
		this.client = client;
	...
	public Dimension render(Graphics2D graphics) {
		...
		int preferredWidth = 160; // Adjust this value as needed

		panelComponent.getChildren().add(TitleComponent.builder()
				.text("SafeRS Drift Net")
		...
		String status = isMoving ? "Animating" : "Not Animating";
		Color statusColor = isMoving ? Color.GREEN : Color.PINK;
