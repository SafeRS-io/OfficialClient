...
public class ZulrahBoatOverlay extends Overlay {
    private final Client client;
    private final ZulrahConfig config;
    private static final int HIGHLIGHTED_OBJECT_ID = 10068;

    @Inject
    public ZulrahBoatOverlay(Client client, ZulrahConfig config) {
