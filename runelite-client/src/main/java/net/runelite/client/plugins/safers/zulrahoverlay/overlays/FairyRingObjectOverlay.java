...
public class FairyRingObjectOverlay extends Overlay {
    private final Client client;
    private final ZulrahConfig config;
    private static final int HIGHLIGHTED_OBJECT_ID = 29228;

    @Inject
    public FairyRingObjectOverlay(Client client, ZulrahConfig config) {
