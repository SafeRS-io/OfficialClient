...
public class PathfinderOverlay extends Overlay {
    ...
    private final long TIMER_DURATION = 1000; // 4 seconds in milliseconds
    ...
    @Inject
    public PathfinderOverlay(Client client, SafeRSMotherlodeConfig config) {
        ...
        this.destinations = Arrays.asList(
                ...
                parseWorldPoint("3727,5682,0"), // rockfall 1

                parseWorldPoint("3727,5682,0"), // rockfall 1
                parseWorldPoint("3731,5683,0"), // rockfall 2
                parseWorldPoint("3735,5678,0"), // rockfall 3
                parseWorldPoint("3747,5673,0"), // deposit box
                parseWorldPoint("3735,5678,0"), // rockfall 3
                parseWorldPoint("3731,5683,0"), // rockfall 2
                parseWorldPoint("3727,5682,0")); // rockfall 1
    }
    ...
    public Dimension render(Graphics2D graphics) {
        ...
        if (currentDestinationIndex < destinations.size()) {
            ...
            if (playerLocation.distanceTo(currentDestination) <= 3) {
