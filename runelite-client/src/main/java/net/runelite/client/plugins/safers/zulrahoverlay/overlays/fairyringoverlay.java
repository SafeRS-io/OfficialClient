...
public class fairyringoverlay extends WidgetItemOverlay {
    ...
    private final Set<Integer> highlightedItemsGroup1 = new HashSet<>(Arrays.asList(772,733)); // tags antidotes and venoms

    public fairyringoverlay() {
        showOnInventory();
    }

    @Override
    public void renderItemOverlay(Graphics2D graphics, int itemId, WidgetItem itemWidget) {
        Color tagColor = config.staffcolor();
