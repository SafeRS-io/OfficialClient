...
public class ZulrahBankOverlay extends Overlay {
    private final Client client;
    private final ZulrahConfig config;
    private static final int HIGHLIGHTED_OBJECT_ID = 26711;

    @Inject
    public ZulrahBankOverlay(Client client, ZulrahConfig config) {
