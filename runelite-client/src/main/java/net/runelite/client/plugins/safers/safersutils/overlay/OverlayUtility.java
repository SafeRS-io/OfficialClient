package net.runelite.client.plugins.safers.safersutils.overlay;
...
import net.runelite.client.plugins.safers.safersutils.rlapi.InterfaceTab;
import net.runelite.client.plugins.safers.safersutils.rlapi.PrayerExtended;
