...
public class TeleportScrollOverlay extends WidgetItemOverlay {
    ...
    private final Set<Integer> highlightedItemsGroup1 = new HashSet<>(Arrays.asList(12938,12939,9790,8013)); // tags antidotes and venoms

    public TeleportScrollOverlay() {
        showOnInventory();
    }

    @Override
    public void renderItemOverlay(Graphics2D graphics, int itemId, WidgetItem itemWidget) {
        Color tagColor = config.scrollcolor();
