...
public class HighlightCauldronBroken extends Overlay {
    private final Client client;
    private final SafeRSWintertodtConfig config;
    private static final int HIGHLIGHTED_OBJECT_ID = 29313;
    private static final int REQUIRED_ITEM_ID = 20696; // ID of the required item in the last inventory slot
    @Inject
    public HighlightCauldronBroken(Client client, SafeRSWintertodtConfig config) {
