...
public class LogTaggerColor extends WidgetItemOverlay {
    ...
    private final Set<Integer> highlightedItemsGroup1 = new HashSet<>(Arrays.asList(20695,123));

    public LogTaggerColor() {
        showOnInventory();
    }

    @Override
    public void renderItemOverlay(Graphics2D graphics, int itemId, WidgetItem itemWidget) {
        Color tagColor = config.LogColor();
