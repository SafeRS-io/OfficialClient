...
public class FletchLogTaggerColor extends WidgetItemOverlay {
    ...
    private final Set<Integer> highlightedItemsGroup1 = new HashSet<>(Arrays.asList(20696,123));

    public FletchLogTaggerColor() {
        showOnInventory();
    }

    @Override
    public void renderItemOverlay(Graphics2D graphics, int itemId, WidgetItem itemWidget) {
        Color tagColor = config.FletchColor();
